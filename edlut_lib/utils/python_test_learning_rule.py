...
# Get the default parameter values of the neuron model
default_param_lrule = simulation.GetLearningRuleDefParams('VogelsSTDP');
...
lrule_params = {
        'max_kernel_change':kernel_lr,
        'tau_kernel_change':0.020,
        'const_change':contant_lr
     }

# Create the learning rule
Vogels_STDP_rule = simulation.AddLearningRule('VogelsSTDP', lrule_params)
...
plt.title('Vogels STDP learning rule')
plt.show()
