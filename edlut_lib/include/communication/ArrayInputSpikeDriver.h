...
class ArrayInputSpikeDriver: public InputSpikeDriver {
	public:
		 ...
		 */
		void LoadInputs(EventQueue * Queue, Network * Net) throw (EDLUTException);
		 ...
		 * \throw EDLUTException If something wrong happens in the input process.
		 */
		void LoadInputs(EventQueue * Queue, Network * Net, int NumSpikes, const double * Times, const long int * Cells) throw (EDLUTException);
