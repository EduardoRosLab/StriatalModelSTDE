...
#ifndef SIMETRICCOSSINSTATE_H_
#define SIMETRICCOSSINSTATE_H_
...
class SimetricCosSinState : public ConnectionState{
	...
	public:
		 ...
		 */
		SimetricCosSinState(unsigned int NumSynapses, float NewMaxMinDistance, float NewCentralAmplitudeFactor, float NewLateralAmplitudeFactor);
