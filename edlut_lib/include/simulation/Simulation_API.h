...
class Simulation_API{
	...
	*/
     ...
     */
    std::vector<int> AddNeuronLayer(int num_neurons, std::string model_name, std::map<std::string, boost::any> param_dict, bool log_activity, bool output_activity) throw (EDLUTException);
    ...
    */
    std::vector<int> AddSynapticLayer(const std::vector<int> & source_neuron, const std::vector<int> & target_neuron, std::map<std::string, boost::any> param_dict) throw (EDLUTException);
    ...
    */
    void AddExternalSpikeActivity(const std::vector<double> & event_time, const std::vector<long int> & neuron_index) throw (EDLUTException);
    ...
    */
	void AddExternalCurrentActivity(const std::vector<double> & event_time, const std::vector<long int> & neuron_index, const std::vector<float> & current_value) throw (EDLUTException);
    ...
    */
    void GetSpikeActivity(std::vector<double> & event_time, std::vector<long int> & neuron_index) throw (EDLUTException);
	...
	*/
	void AddFileInputSpikeActivityDriver(string FileName) throw (EDLUTException);
	...
	* \param FileName name of the file where the input activity is stored.
	*/
	void AddFileInputCurrentActivityDriver(string FileName) throw (EDLUTException);
	...
	* \param FileName name of the file where the input activity is stored.
	*/
	void AddFileOutputSpikeActivityDriver(string FileName) throw (EDLUTException);
	...
	*/
	void AddFileOutputMonitorDriver(string FileName, bool monitor_state) throw (EDLUTException);
	...
	*/
	void AddFileOutputWeightDriver(string FileName, float save_period) throw (EDLUTException);
	...
	*/
	void GetCompressedWeights(std::vector<int> & N_equal_weights, std::vector<float> & equal_weights) throw (EDLUTException);
	...
	*/
	std::vector<float> GetWeights() throw (EDLUTException);
	...
	*/
	std::vector<float> GetSelectedWeights(std::vector<int> synaptic_indexes) throw (EDLUTException);
    ...
    */
    void Initialize() throw (EDLUTException);
    ...
    */
    void SetSimulationParameters(std::map<std::string, boost::any> param_dict) throw (EDLUTException);
    ...
    *
    */
    void RunSimulation(double end_simulation_time) throw (EDLUTException);
     ...
     */
    int AddLearningRule(std::string model_name, std::map<std::string, boost::any> param_dict) throw (EDLUTException);
     ...
     */
    std::map<std::string, boost::any> GetLearningRuleDefParams(std::string model_name) throw (EDLUTException);
     ...
     * \note An exception is raised if a learning rule does not exists with the provided name.
     */
    std::map<std::string, boost::any> GetNeuronModelDefParams(std::string model_name) throw (EDLUTException);
     ...
     */
    std::map<std::string, boost::any> GetIntegrationMethodDefParams(std::string model_name) throw (EDLUTException);
     ...
     */
    std::map<std::string, boost::any> GetLearningRuleParams(int lrule_index) throw (EDLUTException);
     ...
     * \note An exception is raised if the learning rule index does not exist.
     */
    void SetLearningRuleParams(int lrule_index, std::map<std::string, boost::any> newParam) throw (EDLUTException);
     ...
     */
    std::vector<std::map<std::string, boost::any> > GetNeuronParams(std::vector<int> neuron_index) throw (EDLUTException);
	...
	* \note An exception is raised if the neuron index does not exist.
	*/
	std::vector<std::map<std::string, boost::any> > GetSpecificNeuronParams(std::vector<int> neuron_index) throw (EDLUTException);
     ...
     */
    void SetSpecificNeuronParams(int neuron_index, std::map<std::string, boost::any> newParam) throw (EDLUTException);
	...
	*/
	static std::map<std::string, std::string>  GetNeuronModelInfo(string neuronModelName) throw (EDLUTException);
	...
	* \note An exception is raised if the neuron model does not exist.
	*/
	static void PrintNeuronModelInfo(string neuronModelName) throw (EDLUTException);
	...
	*/
	static std::map<std::string, std::string> GetVectorizableParameters(std::string ident) throw (EDLUTException);
	...
	* \throw EDLUTException If the neuron model does not exist with that name.
	*/
	static void PrintVectorizableParameters(std::string ident) throw (EDLUTException);
};
