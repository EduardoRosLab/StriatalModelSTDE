...
#ifndef LIFTIMEDRIVENMODEL_1_2_NEW_H_
#define LIFTIMEDRIVENMODEL_1_2_NEW_H_

/*!
 * \file LIFTimeDrivenModel_1_2_NEW.h
 *
 * \author Francisco Naveros
 * \date October 2016
 *
 * This file declares a class which abstracts a Leaky Integrate-And-Fire neuron model with one 
 * differential equation and two time dependent equations (conductances). This class is a
 * redefinition of LIFTimeDrivenModel_1_2 neuron model using mV, ms, nS and pF units.
 */
...
/*!
 * \class LIFTimeDrivenModel_1_2_NEW
 *
 ...
 * \date May 2016
 */
class LIFTimeDrivenModel_1_2_NEW : public TimeDrivenNeuronModel {
	protected:
		/*!
		...
		/*!
		* \brief Inverse membrane capacitance in 1/pF units
		*/
		float inv_cm;
	...
	public:
		...
		*/
		 ...
		 */
		LIFTimeDrivenModel_1_2_NEW(string NeuronTypeID, string NeuronModelID);
		 ...
		 */
		virtual ~LIFTimeDrivenModel_1_2_NEW();
...
#endif /* LIFTIMEDRIVENMODEL_1_2_NEW_H_ */
