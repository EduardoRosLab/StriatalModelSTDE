...
class NeuronModelFactory {
    ...
    public:
		...
		*/
		 ...
		 */
		 static NeuronModel * CreateNeuronModel(ModelDescription nmodelDescription) throw (EDLUTException);
		...
		*/
		 static ModelDescription ParseNeuronModel(std::string ident, std::string ident_param) throw (EDLUTException);
		 ...
		 * \throw EDLUTException If the neuron model does not exist with that name.
		 */
		 static std::map<std::string, boost::any> GetDefaultParameters(std::string ident) throw (EDLUTException);
		...
		* \throw EDLUTException If the neuron model does not exist with that name.
		*/
		 static std::map<std::string, std::string> GetNeuronModelInfo(std::string ident) throw (EDLUTException);
		...
		* \throw EDLUTException If the neuron model does not exist with that name.
		*/
		 static void PrintNeuronModelInfo(std::string ident) throw (EDLUTException);
