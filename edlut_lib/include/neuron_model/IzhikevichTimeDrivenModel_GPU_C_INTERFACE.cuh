/***************************************************************************
 *                           IzhikevichTimeDrivenModel_GPU_C_INTERFACE.cuh *
 *                           -------------------                           *
...
#ifndef IZHIKEVICHTIMEDRIVENMODEL_GPU_C_INTERFACE_H_
#define IZHIKEVICHTIMEDRIVENMODEL_GPU_C_INTERFACE_H_

/*!
 * \file LIFTimeDrivenModel_GPU_C_INTERFACE.cuh
 *
...
/*!
 * \class LIFTimeDrivenModel_GPU_C_INTERFACE
 *
 *
 * \brief Izhikevich Time-Driven neuron model with a membrane potential, an adaptation variable,
 * three conductances (EXC, INH and NMDA) and one external current. This model is implemented 
 * in CPU to control a GPU class.
 *
 ...
 * \date December 2015
 */
class IzhikevichTimeDrivenModel_GPU_C_INTERFACE : public TimeDrivenNeuronModel_GPU_C_INTERFACE {
	protected:
		/*!
		...
		*/
		IzhikevichTimeDrivenModel_GPU2 ** NeuronModel_GPU2;
	...
	public:
		...
		*/
		 ...
		 */
		IzhikevichTimeDrivenModel_GPU_C_INTERFACE();
		 ...
		 */
		virtual ~IzhikevichTimeDrivenModel_GPU_C_INTERFACE();
		...
		* \throw EDLUTException If it happens a mistake with the parameters in the dictionary.
		*/
		virtual IntegrationMethod_GPU_C_INTERFACE * CreateIntegrationMethod(ModelDescription imethodDescription) throw (EDLUTException);
		...
		*/
		virtual bool compare(const NeuronModel * rhs) const{
			...
			const IzhikevichTimeDrivenModel_GPU_C_INTERFACE * e = dynamic_cast<const IzhikevichTimeDrivenModel_GPU_C_INTERFACE *> (rhs);
			if (e == 0) return false;
...
#endif /* IZHIKEVICHTIMEDRIVENMODEL_GPU_C_INTERFACE_H_ */
