...
#ifndef LIFTIMEDRIVENMODEL_1_3_H_
#define LIFTIMEDRIVENMODEL_1_3_H_

/*!
 * \file LIFTimeDrivenModel_1_3.h
 *
 * \author Francisco Naveros
 * \date April 2018
 *
 * This file declares a class which abstracts a Leaky Integrate-And-Fire neuron model with one 
 * differential equation, two time dependent equations (conductances) and one input current.
 */
 ...
 * \date April 2018
 */
class LIFTimeDrivenModel_1_3 : public TimeDrivenNeuronModel {
	protected:
	...
	public:
		...
		*/
		 ...
		 */
		virtual ~LIFTimeDrivenModel_1_3();
		...
		*/
        ...
        virtual bool compare(const NeuronModel * rhs) const{
            ...
            const LIFTimeDrivenModel_1_3 * e = dynamic_cast<const LIFTimeDrivenModel_1_3 *> (rhs);
            if (e == 0) return false;
...
#endif /* LIFTIMEDRIVENMODEL_1_3_H_ */
