/***************************************************************************
 *                           AdExTimeDrivenModel_GPU_C_INTERFACE.cuh       *
 *                           -------------------                           *
...
#ifndef ADEXTIMEDRIVENMODEL_GPU_C_INTERFACE_H_
#define ADEXTIMEDRIVENMODEL_GPU_C_INTERFACE_H_

/*!
 * \file AdExTimeDrivenModel_GPU_C_INTERFACE.cuh
 *
...
/*!
 * \class AdExTimeDrivenModel_GPU_C_INTERFACE
 *
 *
 * \brief Adaptative Exponential Integrate and Fire (AdEx) Time-Driven neuron model with a membrane potential, an 
 * adaptation variable, three conductances (EXC, INH and NMDA) and one external current. This model is implemented 
 ...
 * \date December 2015
 */
class AdExTimeDrivenModel_GPU_C_INTERFACE : public TimeDrivenNeuronModel_GPU_C_INTERFACE {
	protected:
		/*!
	...
	public:
		...
		*/
		 ...
		 */
		AdExTimeDrivenModel_GPU_C_INTERFACE();
		 ...
		 */
		virtual ~AdExTimeDrivenModel_GPU_C_INTERFACE();
		...
		*/
		virtual bool compare(const NeuronModel * rhs) const{
			...
			const AdExTimeDrivenModel_GPU_C_INTERFACE * e = dynamic_cast<const AdExTimeDrivenModel_GPU_C_INTERFACE *> (rhs);
			if (e == 0) return false;
...
#endif /* ADEXTIMEDRIVENMODEL_GPU_C_INTERFACE_H_ */