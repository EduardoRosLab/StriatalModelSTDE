 ...
 *
 * This class defines the behavior of an input neuron layer that can propagate input currents to the neural network. It includes 
	...
	public:
		...
		*/
        ...
        virtual bool compare(const NeuronModel * rhs) const{
            ...
            const InputCurrentNeuronModel * e = dynamic_cast<const InputCurrentNeuronModel *> (rhs);
            if (e == 0) return false;
