/***************************************************************************
 *                           HHTimeDrivenModel_GPU_C_INTERFACE.cuh         *
 *                           -------------------                           *
...
#ifndef HHTIMEDRIVENMODEL_GPU_C_INTERFACE_H_
#define HHTIMEDRIVENMODEL_GPU_C_INTERFACE_H_

/*!
 * \file HHTimeDrivenModel_GPU_C_INTERFACE.cuh
 *
 * \author Francisco Naveros
 * \date December 2015
 *
 * This file declares a class which abstracts an Hodgkin and Huxley (HH) neuron model with four 
 * differential equations and four time dependent equations (conductances and external current). This model is
...
/*!
 * \class HHTimeDrivenModel_GPU_C_INTERFACE
 *
 *
 * \brief Hodgkin and Huxley (HH) Time-Driven neuron model with a membrane potential, three ion-channel conductances, three
 * conductances and one external current. This model is implemented in CPU to control a GPU class.
 *
 ...
 * \date December 2015
 */
class HHTimeDrivenModel_GPU_C_INTERFACE : public TimeDrivenNeuronModel_GPU_C_INTERFACE {
	protected:
		/*!
	...
	public:
		...
		*/
		 ...
		 *
		 */
		HHTimeDrivenModel_GPU_C_INTERFACE();
		 ...
		 */
		virtual ~HHTimeDrivenModel_GPU_C_INTERFACE();
		...
		*/
		virtual bool compare(const NeuronModel * rhs) const{
			...
			const HHTimeDrivenModel_GPU_C_INTERFACE * e = dynamic_cast<const HHTimeDrivenModel_GPU_C_INTERFACE *> (rhs);
			if (e == 0) return false;
...
#endif /* HHTIMEDRIVENMODEL_GPU_C_INTERFACE_H_ */
