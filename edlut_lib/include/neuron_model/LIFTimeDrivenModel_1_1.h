...
#ifndef LIFTIMEDRIVENMODEL_1_1_H_
#define LIFTIMEDRIVENMODEL_1_1_H_

/*!
 * \file LIFTimeDrivenModel_1_1.h
 *
 * \author Francisco Naveros
 * \date October 2019
 *
 * This file declares a class which abstracts a Leaky Integrate-And-Fire neuron model with one 
 * differential equation and one time dependent equation (conductances).
 */
 ...
 * \date October 2019
 */
class LIFTimeDrivenModel_1_1 : public TimeDrivenNeuronModel {
	protected:
		/*!
	...
	public:
		...
		*/
		const int N_TimeDependentNeuronState = 1;
		 ...
		 */
		virtual ~LIFTimeDrivenModel_1_1();
		...
		*/
        ...
        virtual bool compare(const NeuronModel * rhs) const{
            ...
            const LIFTimeDrivenModel_1_1 * e = dynamic_cast<const LIFTimeDrivenModel_1_1 *> (rhs);
            if (e == 0) return false;
...
#endif /* LIFTIMEDRIVENMODEL_1_1_H_ */
