/***************************************************************************
 *                           LIFTimeDrivenModel_GPU_C_INTERFACE.cuh        *
 *                           -------------------                           *
...
#ifndef LIFTIMEDRIVENMODEL_GPU_C_INTERFACE_H_
#define LIFTIMEDRIVENMODEL_GPU_C_INTERFACE_H_
 ...
 * \date December 2015
 */
class LIFTimeDrivenModel_GPU_C_INTERFACE : public TimeDrivenNeuronModel_GPU_C_INTERFACE {
	protected:
		/*!
		...
		*/
		LIFTimeDrivenModel_GPU2 ** NeuronModel_GPU2;
	...
	public:
		...
		*/
		 ...
		 */
		LIFTimeDrivenModel_GPU_C_INTERFACE();
		 ...
		 */
		virtual ~LIFTimeDrivenModel_GPU_C_INTERFACE();
		...
		*/
		virtual bool compare(const NeuronModel * rhs) const{
			...
			const LIFTimeDrivenModel_GPU_C_INTERFACE * e = dynamic_cast<const LIFTimeDrivenModel_GPU_C_INTERFACE *> (rhs);
			if (e == 0) return false;
...
#endif /* LIFTIMEDRIVENMODEL_GPU_C_INTERFACE_H_ */
