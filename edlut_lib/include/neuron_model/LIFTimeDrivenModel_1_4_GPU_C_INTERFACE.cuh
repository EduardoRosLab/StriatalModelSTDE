/***************************************************************************
 *                           LIFTimeDrivenModel_1_4_GPU_C_INTERFACE.cuh    *
 *                           -------------------                           *
...
#ifndef LIFTIMEDRIVENMODEL_1_4_GPU_C_INTERFACE_H_
#define LIFTIMEDRIVENMODEL_1_4_GPU_C_INTERFACE_H_

/*!
 * \file LIFTimeDrivenModel_1_4_GPU_C_INTERFACE.cuh
 *
...
/*!
 * \class LIFTimeDrivenModel_1_4_GPU_C_INTERFACE
 *
 ...
 * \date May 2013
 */
class LIFTimeDrivenModel_1_4_GPU_C_INTERFACE : public TimeDrivenNeuronModel_GPU_C_INTERFACE {
	protected:
		/*!
	...
	public:
		...
		*/
		 ...
		 *
		 */
		LIFTimeDrivenModel_1_4_GPU_C_INTERFACE();
		 ...
		 */
		virtual ~LIFTimeDrivenModel_1_4_GPU_C_INTERFACE();
		...
		*/
		virtual bool compare(const NeuronModel * rhs) const{
			...
			const LIFTimeDrivenModel_1_4_GPU_C_INTERFACE * e = dynamic_cast<const LIFTimeDrivenModel_1_4_GPU_C_INTERFACE *> (rhs);
			if (e == 0) return false;
