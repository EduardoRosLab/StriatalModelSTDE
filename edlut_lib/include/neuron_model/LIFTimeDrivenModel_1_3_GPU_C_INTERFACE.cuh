/***************************************************************************
 *                           LIFTimeDrivenModel_1_3_GPU_C_INTERFACE.cuh    *
 *                           -------------------                           *
...
#ifndef LIFTIMEDRIVENMODEL_1_3_GPU_C_INTERFACE_H_
#define LIFTIMEDRIVENMODEL_1_3_GPU_C_INTERFACE_H_

/*!
 * \file LIFTimeDrivenModel_1_3_GPU_C_INTERFACE.cuh
 *
 * \author Francisco Naveros
 * \date October 2019
 *
 * This file declares a class which abstracts a Leaky Integrate-And-Fire neuron model with one 
 * differential equation, two time dependent equations (conductances) and one input current. This 
 * model is implemented in CPU to control a GPU class.
 */
...
/*!
 * \class LIFTimeDrivenModel_1_3_GPU_C_INTERFACE
 *
 *
 * \brief Leaky Integrate-And-Fire Time-Driven neuron model with a membrane potential,
 * two conductances and one input current. This model is implemented in CPU to control
 * a GPU class.
 *
 ...
 * \date October 2019
 */
class LIFTimeDrivenModel_1_3_GPU_C_INTERFACE : public TimeDrivenNeuronModel_GPU_C_INTERFACE {
	protected:
		/*!
	...
	public:
		...
		*/
		const int N_TimeDependentNeuronState=3;
		 ...
		 *
		 */
		LIFTimeDrivenModel_1_3_GPU_C_INTERFACE();
		 ...
		 */
		virtual ~LIFTimeDrivenModel_1_3_GPU_C_INTERFACE();
		...
		*/
		virtual bool compare(const NeuronModel * rhs) const{
			...
			const LIFTimeDrivenModel_1_3_GPU_C_INTERFACE * e = dynamic_cast<const LIFTimeDrivenModel_1_3_GPU_C_INTERFACE *> (rhs);
			if (e == 0) return false;
...
#endif /* LIFTIMEDRIVENMODEL_1_3_GPU_C_INTERFACE_H_ */
