...
ModelDescription CosWeightChange::ParseLearningRule(FILE * fh) throw (EDLUTException) {
...
void CosWeightChange::SetParameters(std::map<std::string,boost::any> param_map) throw (EDLUTException){
