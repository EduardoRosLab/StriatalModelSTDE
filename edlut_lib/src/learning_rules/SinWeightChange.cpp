...
ModelDescription SinWeightChange::ParseLearningRule(FILE * fh) throw (EDLUTException) {
...
void SinWeightChange::SetParameters(std::map<std::string, boost::any> param_map) throw (EDLUTException){
