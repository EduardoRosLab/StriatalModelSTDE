...
ModelDescription SimetricCosWeightChange::ParseLearningRule(FILE * fh) throw (EDLUTException) {
...
void SimetricCosWeightChange::SetParameters(std::map<std::string, boost::any> param_map) throw (EDLUTException){
