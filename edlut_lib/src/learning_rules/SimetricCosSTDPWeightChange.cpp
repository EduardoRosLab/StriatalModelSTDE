...
ModelDescription SimetricCosSTDPWeightChange::ParseLearningRule(FILE * fh) throw (EDLUTException) {
...
void SimetricCosSTDPWeightChange::SetParameters(std::map<std::string, boost::any> param_map) throw (EDLUTException){
