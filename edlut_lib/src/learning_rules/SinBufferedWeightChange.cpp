...
ModelDescription SinBufferedWeightChange::ParseLearningRule(FILE * fh) throw (EDLUTException) {
...
void SinBufferedWeightChange::SetParameters(std::map<std::string, boost::any> param_map) throw (EDLUTException){
