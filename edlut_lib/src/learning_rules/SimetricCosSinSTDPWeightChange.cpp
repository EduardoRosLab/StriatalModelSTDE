...
ModelDescription SimetricCosSinSTDPWeightChange::ParseLearningRule(FILE * fh) throw (EDLUTException) {
...
void SimetricCosSinSTDPWeightChange::SetParameters(std::map<std::string, boost::any> param_map) throw (EDLUTException){
