...
double SimetricCosSinSTDPState::GetPrintableValuesAt(unsigned int index, unsigned int position){
...
void SimetricCosSinSTDPState::SetWeight(unsigned int index, float weight, float max_weight){
}
