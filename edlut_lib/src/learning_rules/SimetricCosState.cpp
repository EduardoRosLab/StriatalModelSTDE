...
double SimetricCosState::GetPrintableValuesAt(unsigned int index, unsigned int position){
...
void SimetricCosState::SetWeight(unsigned int index, float weight, float max_weight){
}