...
ModelDescription STDPWeightChange::ParseLearningRule(FILE * fh) throw (EDLUTException) {
...
void STDPWeightChange::SetParameters(std::map<std::string, boost::any> param_map) throw (EDLUTException){
...
std::map<std::string,boost::any> STDPWeightChange::GetDefaultParameters(){
	...
	newMap["max_LTP"] = boost::any(0.016f);
	newMap["tau_LTP"] = boost::any(0.100f);
	newMap["max_LTD"] = boost::any(0.033f);
