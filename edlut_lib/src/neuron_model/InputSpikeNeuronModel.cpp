...
std::map<std::string, boost::any> InputSpikeNeuronModel::GetSpecificNeuronParameters(int index) const throw (EDLUTException){
	return GetParameters();
}

void InputSpikeNeuronModel::SetParameters(std::map<std::string, boost::any> param_map) throw (EDLUTException){
...
ModelDescription InputSpikeNeuronModel::ParseNeuronModel(std::string FileName) throw (EDLUTFileException){
