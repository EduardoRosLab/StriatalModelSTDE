...
std::map<std::string, boost::any> EgidioGranuleCell_TimeDriven::GetSpecificNeuronParameters(int index) const throw (EDLUTException){
	return GetParameters();
}

void EgidioGranuleCell_TimeDriven::SetParameters(std::map<std::string, boost::any> param_map) throw (EDLUTException){
...
IntegrationMethod * EgidioGranuleCell_TimeDriven::CreateIntegrationMethod(ModelDescription imethodDescription) throw (EDLUTException){
...
ModelDescription EgidioGranuleCell_TimeDriven::ParseNeuronModel(std::string FileName) throw (EDLUTFileException){
	FILE *fh;
