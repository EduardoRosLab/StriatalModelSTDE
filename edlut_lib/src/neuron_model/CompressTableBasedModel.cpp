...
std::map<std::string, boost::any> CompressTableBasedModel::GetSpecificNeuronParameters(int index) const throw (EDLUTException){
	return GetParameters();
}

void CompressTableBasedModel::SetParameters(std::map<std::string, boost::any> param_map) throw (EDLUTException){
...
ModelDescription CompressTableBasedModel::ParseNeuronModel(std::string FileName) throw (EDLUTFileException){
