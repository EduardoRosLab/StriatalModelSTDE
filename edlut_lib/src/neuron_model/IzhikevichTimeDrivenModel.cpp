...
std::map<std::string, boost::any> IzhikevichTimeDrivenModel::GetSpecificNeuronParameters(int index) const throw (EDLUTException){
	return GetParameters();
}

void IzhikevichTimeDrivenModel::SetParameters(std::map<std::string, boost::any> param_map) throw (EDLUTException){
...
IntegrationMethod * IzhikevichTimeDrivenModel::CreateIntegrationMethod(ModelDescription imethodDescription) throw (EDLUTException){
...
ModelDescription IzhikevichTimeDrivenModel::ParseNeuronModel(std::string FileName) throw (EDLUTFileException){
	FILE *fh;
