...
std::map<std::string, boost::any> AdExTimeDrivenModel::GetSpecificNeuronParameters(int index) const throw (EDLUTException){
	return GetParameters();
}

void AdExTimeDrivenModel::SetParameters(std::map<std::string, boost::any> param_map) throw (EDLUTException){
...
IntegrationMethod * AdExTimeDrivenModel::CreateIntegrationMethod(ModelDescription imethodDescription) throw (EDLUTException){
...
ModelDescription AdExTimeDrivenModel::ParseNeuronModel(std::string FileName) throw (EDLUTFileException){
	FILE *fh;
