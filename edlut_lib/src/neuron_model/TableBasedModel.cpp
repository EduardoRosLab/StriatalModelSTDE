...
std::map<std::string, boost::any> TableBasedModel::GetSpecificNeuronParameters(int index) const throw (EDLUTException){
	return GetParameters();
}

void TableBasedModel::SetParameters(std::map<std::string, boost::any> param_map) throw (EDLUTException){
...
ModelDescription TableBasedModel::ParseNeuronModel(std::string FileName) throw (EDLUTFileException){
