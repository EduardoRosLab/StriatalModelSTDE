...
std::map<std::string, boost::any> HHTimeDrivenModel::GetSpecificNeuronParameters(int index) const throw (EDLUTException){
	return GetParameters();
}

void HHTimeDrivenModel::SetParameters(std::map<std::string, boost::any> param_map) throw (EDLUTException){
...
IntegrationMethod * HHTimeDrivenModel::CreateIntegrationMethod(ModelDescription imethodDescription) throw (EDLUTException){
...
ModelDescription HHTimeDrivenModel::ParseNeuronModel(std::string FileName) throw (EDLUTFileException){
	FILE *fh;
