...
void NeuronModel::SetParameters(std::map<std::string, boost::any> param_map) throw (EDLUTException){
...
void NeuronModel::SetSpecificNeuronParameters(int index, std::map<std::string, boost::any> param_map) throw (EDLUTException){
	if (!param_map.empty()){
		cout << "Parameters ";
