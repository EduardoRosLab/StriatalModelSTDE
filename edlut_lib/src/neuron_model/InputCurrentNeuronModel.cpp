...
std::map<std::string, boost::any> InputCurrentNeuronModel::GetSpecificNeuronParameters(int index) const throw (EDLUTException){
	return GetParameters();
}

void InputCurrentNeuronModel::SetParameters(std::map<std::string, boost::any> param_map) throw (EDLUTException){
...
ModelDescription InputCurrentNeuronModel::ParseNeuronModel(std::string FileName) throw (EDLUTFileException){
