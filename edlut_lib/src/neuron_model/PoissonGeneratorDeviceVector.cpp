...
std::map<std::string, boost::any> PoissonGeneratorDeviceVector::GetSpecificNeuronParameters(int index) const throw (EDLUTException){
...
void PoissonGeneratorDeviceVector::SetParameters(std::map<std::string, boost::any> param_map) throw (EDLUTException){
...
void PoissonGeneratorDeviceVector::SetSpecificNeuronParameters(int index, std::map<std::string, boost::any> param_map) throw (EDLUTException){
...
ModelDescription PoissonGeneratorDeviceVector::ParseNeuronModel(std::string FileName) throw (EDLUTFileException){
	FILE *fh;
