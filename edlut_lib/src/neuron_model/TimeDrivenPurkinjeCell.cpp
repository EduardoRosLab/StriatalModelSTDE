...
std::map<std::string, boost::any> TimeDrivenPurkinjeCell::GetSpecificNeuronParameters(int index) const throw (EDLUTException){
	return GetParameters();
}

void TimeDrivenPurkinjeCell::SetParameters(std::map<std::string, boost::any> param_map) throw (EDLUTException){
...
IntegrationMethod * TimeDrivenPurkinjeCell::CreateIntegrationMethod(ModelDescription imethodDescription) throw (EDLUTException){
...
ModelDescription TimeDrivenPurkinjeCell::ParseNeuronModel(std::string FileName) throw (EDLUTFileException){
	FILE *fh;
