...
void LIFTimeDrivenModel_1_4_GPU_NEW::SynapsisEffect(int index, VectorNeuronState_GPU * state, Interconnection * InputConnection){
...
InternalSpike * LIFTimeDrivenModel_1_4_GPU_NEW::ProcessInputSpike(Interconnection * inter, Neuron * target, double time){
...
bool LIFTimeDrivenModel_1_4_GPU_NEW::UpdateState(int index, VectorNeuronState * State, double CurrentTime){
...
bool LIFTimeDrivenModel_1_4_GPU_NEW::CheckSynapseTypeNumber(int Type){
