...
std::map<std::string, boost::any> LIFTimeDrivenModel_IS::GetSpecificNeuronParameters(int index) const throw (EDLUTException){
	return GetParameters();
}

void LIFTimeDrivenModel_IS::SetParameters(std::map<std::string, boost::any> param_map) throw (EDLUTException){
...
IntegrationMethod * LIFTimeDrivenModel_IS::CreateIntegrationMethod(ModelDescription imethodDescription) throw (EDLUTException){
...
ModelDescription LIFTimeDrivenModel_IS::ParseNeuronModel(std::string FileName) throw (EDLUTFileException){
	FILE *fh;
