...
std::map<std::string, boost::any> AdExTimeDrivenModelVector::GetSpecificNeuronParameters(int index) const throw (EDLUTException){
...
void AdExTimeDrivenModelVector::SetParameters(std::map<std::string, boost::any> param_map) throw (EDLUTException){
...
void AdExTimeDrivenModelVector::SetSpecificNeuronParameters(int index, std::map<std::string, boost::any> param_map) throw (EDLUTException){
...
IntegrationMethod * AdExTimeDrivenModelVector::CreateIntegrationMethod(ModelDescription imethodDescription) throw (EDLUTException){
...
ModelDescription AdExTimeDrivenModelVector::ParseNeuronModel(std::string FileName) throw (EDLUTFileException){
	FILE *fh;
