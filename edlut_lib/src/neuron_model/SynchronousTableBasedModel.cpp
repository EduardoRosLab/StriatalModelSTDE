...
void SynchronousTableBasedModel::LoadNeuronModel(string ConfigFile) throw (EDLUTFileException){
	FILE *fh;
	long Currentline = 0L;
...
void SynchronousTableBasedModel::LoadNeuronModel() throw (EDLUTFileException){
...
std::map<std::string, boost::any> SynchronousTableBasedModel::GetSpecificNeuronParameters(int index) const throw (EDLUTException){
	return GetParameters();
}

void SynchronousTableBasedModel::SetParameters(std::map<std::string, boost::any> param_map) throw (EDLUTException){
...
ModelDescription SynchronousTableBasedModel::ParseNeuronModel(std::string FileName) throw (EDLUTFileException){
