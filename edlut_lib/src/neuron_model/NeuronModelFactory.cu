...
std::vector<std::string> NeuronModelFactory::GetAvailableNeuronModels(){
	...
	availableNeuronModels.push_back(LIFTimeDrivenModel_DA::GetName());
...
void NeuronModelFactory::InitializeNeuronModelFactory(){
	if (NeuronModelFactory::NeuronModelMap.empty()){
		...
		NeuronModelFactory::NeuronModelMap[LIFTimeDrivenModel_DA::GetName()] =
			NeuronModelFactory::NeuronModelClass(
				LIFTimeDrivenModel_DA::ParseNeuronModel,
				LIFTimeDrivenModel_DA::CreateNeuronModel,
				LIFTimeDrivenModel_DA::GetDefaultParameters,
				LIFTimeDrivenModel_DA::GetNeuronModelInfo);
...
NeuronModel * NeuronModelFactory::CreateNeuronModel(ModelDescription nmodelDescription) throw (EDLUTException){
...
ModelDescription NeuronModelFactory::ParseNeuronModel(std::string ident, std::string ident_param) throw (EDLUTException) {
    NeuronModelFactory::InitializeNeuronModelFactory();
    // Find the rule description name in the learning rule map
    std::map<std::string, NeuronModelFactory::NeuronModelClass >::const_iterator it =
...
std::map<std::string, boost::any> NeuronModelFactory::GetDefaultParameters(std::string ident) throw (EDLUTException){
    NeuronModelFactory::InitializeNeuronModelFactory();
    // Find the rule description name in the learning rule map
    std::map<std::string, NeuronModelFactory::NeuronModelClass >::const_iterator it =
            NeuronModelFactory::NeuronModelMap.find(ident);
...
std::map<std::string, std::string> NeuronModelFactory::GetNeuronModelInfo(std::string ident) throw (EDLUTException){
	NeuronModelFactory::InitializeNeuronModelFactory();
	// Find the rule description name in the learning rule map
	std::map<std::string, NeuronModelFactory::NeuronModelClass >::const_iterator it =
		NeuronModelFactory::NeuronModelMap.find(ident);
...
void NeuronModelFactory::PrintNeuronModelInfo(std::string ident) throw (EDLUTException){
	NeuronModelFactory::InitializeNeuronModelFactory();
	// Find the rule description name in the learning rule map
	std::map<std::string, NeuronModelFactory::NeuronModelClass >::const_iterator it =
		NeuronModelFactory::NeuronModelMap.find(ident);
...
std::map<std::string, std::string> NeuronModelFactory::GetVectorizableParameters(std::string ident) throw (EDLUTException){
	NeuronModelFactory::InitializeNeuronModelFactory();
	// Find the rule description name in the learning rule map
	std::map<std::string, NeuronModelFactory::NeuronModelClass >::const_iterator it =
		NeuronModelFactory::NeuronModelMap.find(ident);
...
void NeuronModelFactory::PrintVectorizableParameters(std::string ident) throw (EDLUTException){
	NeuronModelFactory::InitializeNeuronModelFactory();
	// Find the rule description name in the learning rule map
	std::map<std::string, NeuronModelFactory::NeuronModelClass >::const_iterator it =
		NeuronModelFactory::NeuronModelMap.find(ident);
