...
void FixedStepSRM::SetParameters(std::map<std::string, boost::any> param_map) throw (EDLUTException){
...
ModelDescription FixedStepSRM::ParseIntegrationMethod(FILE * fh) throw (EDLUTException){
