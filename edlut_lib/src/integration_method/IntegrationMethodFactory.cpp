...
#include "../../include/neuron_model/LIFTimeDrivenModel_DA.h"
...
template class IntegrationMethodFactory<LIFTimeDrivenModel_DA>;
...
//				Bifixed_BDFn<Neuron_Model>::GetDefaultParameters);
		...
		//        IntegrationMethodFactory<Neuron_Model>::IntegrationMethodMap[FixedStepSRM<Neuron_Model>::GetName()] =
		//                IntegrationMethodFactory<Neuron_Model>::IntegrationMethodClass(
		//                        FixedStepSRM<Neuron_Model>::ParseIntegrationMethod,
		//                        FixedStepSRM<Neuron_Model>::CreateIntegrationMethod,
		//                        FixedStepSRM<Neuron_Model>::GetDefaultParameters);
