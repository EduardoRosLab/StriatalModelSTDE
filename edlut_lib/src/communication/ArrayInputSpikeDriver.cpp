...
void ArrayInputSpikeDriver::LoadInputs(EventQueue * Queue, Network * Net) throw (EDLUTException){
	return;
}

void ArrayInputSpikeDriver::LoadInputs(EventQueue * Queue, Network * Net, int NumSpikes, const double * Times, const long int * Cells) throw (EDLUTException){
	if (NumSpikes>0){
