...
void ArrayInputCurrentDriver::LoadInputs(EventQueue * Queue, Network * Net) throw (EDLUTFileException){
	return;
}

void ArrayInputCurrentDriver::LoadInputs(EventQueue * Queue, Network * Net, int NumCurrents, const double * Times, const long int * Cells, const float * Currents) throw (EDLUTFileException){
